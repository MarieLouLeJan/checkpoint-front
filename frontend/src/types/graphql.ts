...
export type AddCountryMutation = { __typename?: 'Mutation', addCountry: { __typename?: 'Country', code: string, continent?: { __typename?: 'Continent', id: number, name: string } | null } };
